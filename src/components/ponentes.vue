    ...
    <div class="mx-auto flex max-w-7xl flex-col items-start gap-10 md:flex-row">
      ...
      <div class="flex flex-wrap justify-center gap-4 mt-5 w-full min-w-0 flex-1 md:mt-0 md:order-1" data-aos="fade-down" data-aos-anchor-placement="top-bottom">
        <div
          ...
          <img class="mx-auto mt-4 mb-4 h-32 w-32 rounded-full shadow-lg" :src="ponente.imagen" :alt="`Foto de ${ponente.nombre}`" loading="lazy" />
          ...
          <a
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path
                d="M9 4H3.5C3.10218 4 2.72064 4.15804 2.43934 4.43934C2.15804 4.72064 2 5.10218 2 5.5V12.5C2 12.8978 2.15804 13.2794 2.43934 13.5607C2.72064 13.842 3.10218 14 3.5 14H10.5C10.8978 14 11.2794 13.842 11.5607 13.5607C11.842 13.2794 12 12.8978 12 12.5V7M5 11L14 2M14 2H10.5M14 2V5.5"
                stroke="#1DC270"
